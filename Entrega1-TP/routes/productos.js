...
const fs = require('fs');
const app = express()
const { productos, checkId, readFile, readFileProducts, assignedNewId, readFileArrayId } = require('../controllers/controllerProductos');

const admin = require('../LogicaNegocio/login')
